...
export default function Cadastro() {
  ...
  const { setUserId, setUserEmail, setMasterKey } = useUser();
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const localPayload = {
        encryptedData: response.encryptedBlob,
      ...
      Alert.alert("Sucesso", "Conta criada com segurança!", [{ text: "OK", onPress: () => replace("/(tabs)/home") }]);
    } catch (err: any) {
      console.error(err);
        ...
        <ThemedView style={styles.container}>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.buttons}>
              ...
              <Button mode="outlined" onPress={() => back()} disabled={isLoading} contentStyle={{ height: 50 }}>
                Voltar para Login
              </Button>
            </View>
          </View>
